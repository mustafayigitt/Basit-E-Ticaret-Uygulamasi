...
namespace Project
{
    public partial class Giris : Form
    {
        ...
        public void giris_yap(int sayi) // Bu fonksiyonda gönderilen değer üzerinden hangi dosya açılması amacıyla oluşturuldu.
        {
            if (sayi == 1)
            {
                StreamReader read = new StreamReader(@"C:\Users\MUSTAFA\Desktop\yonetici.txt", Encoding.Default);
            ...
            else if (sayi == 2)
            {
                try
                {
                    StreamReader read = new StreamReader(@"C:\Users\MUSTAFA\Desktop\musteri.txt", Encoding.Default);
        ...
        {
            if (File.Exists(@"C:\Users\MUSTAFA\Desktop\" + giris_isim + ".txt") == false)  // Eğer giriş yapılan isime ozel dosya yok ise oluşturulacak
            {
                FileStream fs = File.Create(@"C:\Users\MUSTAFA\Desktop\" + giris_isim + ".txt");
                fs.Close();
        ...
        {
            FileStream fil = new FileStream(@"C:\Users\MUSTAFA\Desktop\musteri.txt", FileMode.OpenOrCreate, FileAccess.Write);
            fil.Close();
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        StreamWriter sw = File.AppendText(@"C:\Users\MUSTAFA\Desktop\musteri.txt");
        ...
        {
            StreamReader sr = new StreamReader(@"C:\Users\MUSTAFA\Desktop\musteri.txt", Encoding.Default);
