...
namespace Project
{
    public partial class MusteriForm : Form
    {
        ...
        {
            StreamReader oku = new StreamReader(@"C:\Users\MUSTAFA\Desktop\urunler.txt");
        ...
        private void siparis_adet_onay_Click(object sender, EventArgs e)
        {
            ...
            siparis_adet_numericUpDown.Value = 1;
        }
        ...
        private void btnTemizle_Click(object sender, EventArgs e) // Sepetteki ürün secildiyse ilgili ürünü siliyor 
        {
            if(listViewSepetim.SelectedItems.Count > 0)  
            {
                for(int i=0; i < dataGridUrunler.RowCount -1 ; i++) // Ürün, ürünler listesinde bulunup yeni adet ekleniyor
                {
                    ...
                    {
                        dataGridUrunler.Rows[i].Cells[3].Value = (Convert.ToInt32(dataGridUrunler.Rows[i].Cells[3].Value) + Convert.ToInt32(listViewSepetim.SelectedItems[0].SubItems[3].Text)).ToString();
                    }
                }
        ...
        {
            string siparisDetay = "";
            StreamWriter yaz = File.AppendText(@"C:\Users\MUSTAFA\Desktop\" + Giris.giris_isim + ".txt");
        ...
        public void gecmisAlisverisYukle() // Giriş yapan kullanıcının ilgili dosyasına gidip sipariş verilerini çekiyor.
        {
            ...
            StreamReader streamReader = new StreamReader(@"C:\Users\MUSTAFA\Desktop\" + Giris.giris_isim +".txt", Encoding.Default);
        ...
        {
           StreamWriter sw = new StreamWriter(@"C:\Users\MUSTAFA\Desktop\urunler.txt");
        ...
        {
            StreamWriter sw = File.AppendText(@"C:\Users\MUSTAFA\Desktop\gorusler.txt");
